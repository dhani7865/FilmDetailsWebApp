...
public class FilmDAO {
	...
	static Film_ oneFilm = null; // creating object for film equal to null
	...
	private static Map<String, Film_> contentProvider = new HashMap<String, Film_>();
	private static Map<String,Film_> simplefilms;
	private static ArrayList<Film_> filmsList;
	...
	public static Film_ searchFilm(String strid){
	...
	public Map<String, Film_> getModel(){
	...
	static {
		simplefilms = new LinkedHashMap<String,Film_>();
		simplefilms.put("123456", 
				new Film_(123456, "Four Lions", 2010, "Chris Morris, Omar, Hassan, Barry, Waj and Faisal", 
	...
	public static Map<String,Film_> getSampleFilms() {
		return(simplefilms);
	}
	 ...
	 * @return
	 */
	public static Film_ getFilm(int id) {
		if (id == 0) {
			id = 12345;
	...
	public static Film_ getFilmOrDefault(int id) {
		//		Film_ film = getFilmByID(id);
		Film_ film = getFilm(id);
		if (film == null) {
			Film_ films = new Film_(123456,
					"Four Lions", 
					2010, 
					"Chris Morris, Omar, Hassan, Barry, Waj and Faisal", 
					"Chris Morris, Omar, Hassan, Barry, Waj and Faisal",
	...
	public static Film_ getNamedFilm(int id, String title, int year, String director, String stars, String review) {
		Collection<Film_> films = getSampleFilms().values();
		for(Film_ f: films) {
	...
	private static Film_ getNextFilm(ResultSet rs){
		Film_ thisFilm = null; // Creating film variable equal to null
	 ...
	 * Create: insertFilm(Film_)- this inserts a new film into the table films.
	 * Read: getAllFilms() - this retrieves all rows; it would then return all the films from the database.
	 * Update: updateFilm(Film_)- this updates an existing film in the database.
	 * Delete: deleteFilm(FIlm) - this removes an existing film in the database based on the FilmID.
	 * @return dhanyaal
	 */
	// Creating public array list to get/list all films from the array
	public static ArrayList<Film_> getAllFilms() {
		ArrayList<Film_> allFilms = new ArrayList<Film_>();
	...
	/**
	 *  insert statement
	 *  input	is	a	Film_ object	to insert in the database,	
	 ...
	 *  I have also created parameter Film_ films for insertFilms.
	 *  Creating public boolean for insert film to insert films to the database
	 * @param film
	 * @return
	 * @throws SQLException
	 */
	public static boolean insertFilm(Film_ film) throws SQLException {
		openConnection(); // open database connection
	 ...
	 * 	Connection and creates sql query, which lets the user update the data in the database. 
	 * 	I have also created parameter Film film for UpdateFilm
	 * 	Creating public array list to update films from the array
	 * @param film
	 * @return
	 * @throws SQLException
	 */
	public static boolean updateFilm(Film_ film) throws SQLException {
		openConnection(); // open database connection
		Statement statement = null; // statement object = null
		ResultSet resultset = null; // resultset object = null
		// Creating try to open the connection
	...
	// Get the film by ID
	public static Film_ getFilmByID(int id){
		// Open the connection
		openConnection();
	...
	public static Film_ getFilms(String filmTitle, String filmYear, String filmDirector, String filmStars,
			String filmReview) {
		// TODO Auto-generated method stub
		return null;
	}
	public static ArrayList<Film_> getFilmsMatching(String search) {
		// TODO Auto-generated method stub
		return null;
	}
