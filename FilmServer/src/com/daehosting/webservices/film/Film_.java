...
// Importing the xml root element
import javax.xml.bind.annotation.XmlRootElement;

// Calling the xml root element
@XmlRootElement
...
public class Film_ {
	...
	public Film_(int id, String title, int year, String director, String stars,String review) {
		super();
		this.id = id;
		this.title = title;
		this.year = year;
	...
	// Setter and getter for the year
	public int getYear() {
		return year;
	}
