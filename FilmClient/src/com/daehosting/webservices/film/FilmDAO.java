...
public class FilmDAO {
	 ...
	 * Create: insertFilm(Film)- this inserts a new film into the table films.
	 * Read: getAllFilms() - this retrieves all films; it would then return all the films from the database.
	 * Update: updateFilm(Film)- this updates an existing film in the database.
